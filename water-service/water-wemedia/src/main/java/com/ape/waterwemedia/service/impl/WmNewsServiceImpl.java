...
import com.ape.common.constants.WemediaConstants;
import com.ape.common.constants.WmNewsMessageConstants;
import com.ape.waterwemedia.mapper.WmMaterialMapper;
import com.ape.waterwemedia.mapper.WmNewsMapper;
import com.ape.waterwemedia.mapper.WmNewsMaterialMapper;
...
import com.ape.common.exception.CustomException;
...
import com.ape.model.wemedia.pojos.WmNewsMaterial;
...
//        wmNewsAutoScanService.autoScanWmNews(wmNews.getId());
    ...
    private void saveRelativeInfo(List<String> materials, Integer newsId, Short type) {
        if (materials != null && !materials.isEmpty()) {
            ...
            //提取出每个对象的id属性,结果为包含所有WmMaterial对象的id值的List<Integer>
    ...
    public ResponseResult delNews(int id) {
        if (id > 0) {
            iArticleClient.delArticle(baseMapper.selectById(id).getArticleId());
            wmNewsMaterialMapper.delete(Wrappers.<WmNewsMaterial>lambdaQuery().in(WmNewsMaterial::getNewsId, id));
